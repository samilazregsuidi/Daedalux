...
process::process(const process & other) : thread(other) {}
...
void process::setProgState(program * newS) { setParent(newS); }

program * process::getProgState(void) const { return dynamic_cast<program *>(getParent()); }
